...
router.get('/', authMiddleware, roleMiddleware('Administrador', 'Empleado'), categoriaController.getAll);
router.get('/:id', authMiddleware, roleMiddleware('Administrador', 'Empleado'), categoriaController.getById);
